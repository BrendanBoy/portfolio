...
?>
    ...
    <main id="about">
        <section id="profile">
            ...
            <p>The largest project I have worked on to date was as a freelance programmer for Videotel. I used html and xml to build test modules utilised in a browser based interactive training package for the maritime industry.</p>
            ...
            <p>To further this aim I have been participating in the <a href="scs.php#scs">Scion Coalition Scheme</a>, an intensive training program designed to fully prepare candidates to enter this industry.</p>
        </section>
    </main>
